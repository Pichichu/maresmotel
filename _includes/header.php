            ...
            <div class="rd-navbar-aside-outer">
                <div class="rd-navbar-aside">
                    ...
                    <div class="rd-navbar-aside-right rd-navbar-collapse">
                        ...
                        <a class="button button-md button-ujarak button-default-outline" href="#contacto">Entrar en contacto</a>
                    </div>
                </div>
            </div>
                ...
                <div class="rd-navbar-main">
                    <div class="rd-navbar-nav-wrap">
                        <ul class="list-inline list-inline-md rd-navbar-corporate-list-social">
                            ...
                            <li><a class="icon fa fa-twitter" href="https://twitter.com/maresmotel?lang=es"></a></li>
                            <li><a class="icon fa fa-tiktok" target="_blank" href="https://www.tiktok.com/@maresmotel"></a></li>
                            <li><a class="icon fa fa-instagram" target="_blank" href="https://www.instagram.com/maresmotel/"></a></li>
                        </ul>
                        <ul class="rd-navbar-nav">
                            <li class="rd-nav-item active"><a class="rd-nav-link" href="index.php">Inicio</a></li>
                            <li class="rd-nav-item"><a class="rd-nav-link" href="#sobre-nosotros">Sobre nosotros</a></li>
                            <li class="rd-nav-item"><a class="rd-nav-link" href="#suite">Suite</a></li>
                            <li class="rd-nav-item"><a class="rd-nav-link" href="#galeria">Galería</a></li>
